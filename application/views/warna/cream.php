<div class="container-fluid">
    ...
    <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <img src="<?php echo base_url('assets/img/sliders.jpg') ?>" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="<?php echo base_url('assets/img/slide0.jpg') ?>" class="d-block w-100" alt="...">
            </div>
        </div>
    ...
    <div class="row text-center mt-3">
        <?php foreach ($cream as $brg) : ?>
            <div class="card ml-5 mb-4" style="width: 18rem;">
